...
{
    /// <summary>
    /// Interaction logic for ShowCategoryTasks.xaml
    /// </summary>
    public partial class ShowCategoryTasks : Page
    {
        public static Category SelectedCategory { get; set; }
        public ShowCategoryTasks(Category selectedCategory)
        {
            InitializeComponent();
        ...
        private async void categoryTasksPage_Loaded(object sender, RoutedEventArgs e)
        {
            await System.Threading.Tasks.Task.Run(() =>
            {
                this.Dispatcher.Invoke(() =>
                {
                    this.DataContext = new ShowCategoryTasksViewModel(SelectedCategory);
                });
            });
        }
        ...
        private async void tasksList_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            ...
            if (clickedItem != null)
            {
                ...
                if (editTaskWindow.DialogResult == true)
                    await System.Threading.Tasks.Task.Run(() => { this.Dispatcher.Invoke(() => { this.DataContext = new ShowCategoryTasksViewModel(SelectedCategory); }); });
